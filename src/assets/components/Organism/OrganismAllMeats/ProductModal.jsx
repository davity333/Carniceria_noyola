...
function ProductModal  ({ selectedProducts, onClose, updateQuantity }) {
  ...
  return (
    <div className="fixed inset-0 flex justify-end bg-gray-800 bg-opacity-50 font-light">
      <div className="bg-white w-96 p-6 m-4 rounded-lg shadow-lg">
        ...
        <button className="bg-blue-500 mt-4 px-4 py-2 rounded" onClick={handlePay}>Completar compra</button>
