...
import cerrarSesion from "/cerrarSesionUsuario.png";
...
{ localStorage.getItem('token') && <img onClick={logout} src={cerrarSesion} alt="cerrar" className='m-1 hover:bg-[#2c2f1c66] 
py-1 px-1 rounded-full w-12 cursor-pointer flex justify-between items-center 
md:justify-start sm:m-7' title='Cerrar sesión'/>}
